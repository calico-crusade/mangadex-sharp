# MangaDexSharp.Utilities.Cli.Verbs.ExportReadListOptions

- **Kind:** `class`
- **Access:** `public`
- **Assembly/project:** [MangaDexSharp.Utilities.Cli](../../packages/../apps/utilities-cli.md)
- **Source:** [src/MangaDexSharp.Utilities.Cli/Verbs/ExportReadListVerb.cs:6](https://github.com/calico-crusade/mangadex-sharp/blob/main/src/MangaDexSharp.Utilities.Cli/Verbs/ExportReadListVerb.cs#L6)
...
| --- | --- | --- | --- |
| Property | `FilePath` | `string` | public |
| Property | `IncludeLatestChapter` | `bool` | public |
| Property | `ReadStatus` | `string?` | public |
| Property | `PreferredLanguage` | `string` | public |
