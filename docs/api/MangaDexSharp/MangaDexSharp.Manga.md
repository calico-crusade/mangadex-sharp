...
- **Source:** [src/MangaDexSharp/Models/Manga/Manga.cs:6](https://github.com/calico-crusade/mangadex-sharp/blob/main/src/MangaDexSharp/Models/Manga/Manga.cs#L6)

## Purpose

Represents a manga item returned from the MD api

This page exists so references to [Manga](https://github.com/calico-crusade/mangadex-sharp/blob/main/src/MangaDexSharp/Models/Manga/Manga.cs#L6) have a stable documentation target in the repo. It records what the type is used for, why it is present in the solution, and the members exposed by the current source.
