# MangaDexSharp.Chapter

- **Kind:** `class`
- **Access:** `public`
- **Assembly/project:** [MangaDexSharp](../../packages/mangadexsharp.md)
- **Source:** [src/MangaDexSharp/Models/Chapter/Chapter.cs:6](https://github.com/calico-crusade/mangadex-sharp/blob/main/src/MangaDexSharp/Models/Chapter/Chapter.cs#L6)

## Purpose

Represents a chapter returned by the MD api

This page exists so references to [Chapter](https://github.com/calico-crusade/mangadex-sharp/blob/main/src/MangaDexSharp/Models/Chapter/Chapter.cs#L6) have a stable documentation target in the repo. It records what the type is used for, why it is present in the solution, and the members exposed by the current source.
